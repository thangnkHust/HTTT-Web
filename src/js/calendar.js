...
var calendar = {
  test(){
    ...
    var result = this.getGioHoangDao(this.jdn(9, 1, 2021));
    var lunar = this.getLunarDate(9, 1, 2021);
    console.log(result);
    console.log(lunar);
    // alert(result);
  },

  // Get gio hoang dao by jd 
  getGioHoangDao(jd) {
...
var FIRST_DAY = calendar.jdn(25, 1, 1800); // Tet am lich 1800
var LAST_DAY = calendar.jdn(31, 12, 2199);
